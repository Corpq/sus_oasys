...
@section('content')
<div>
    <h1>MODIFICAAR HISTORIAL MEDICO</h1>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="detalle" class="form-control" id="editor" cols="30" rows="100" style="width: 100%;height:500px"><p>{!!$historial->detalle!!}</p></textarea>
