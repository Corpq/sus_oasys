                ...
                <table id="example1" class="table table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$pago->doctor->apellidos." ".$pago->doctor->nombres." ".$pago->doctor->especialidad}}</td>
                            ...
                            <td style="text-align: center">
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <a href="{{url('admin/pagos/'.$pago->id.'/confirm-delete')}}" type="button" class="btn btn-danger btn-sm"><i class="bi bi-trash3"></i></a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
                        ...
                        $("#example1").DataTable({
                            ...
                            buttons: [{
                                    ...
                                    buttons: [{
                                        ...
                                        text: '<button class="btn btn-danger btn-sm btn-block" ><i class="bi bi-file-earmark-pdf-fill"> PDF</i></button>',
                                        extend: 'pdf'
                                    }, {
                                        text: '<button class="btn btn-secondary btn-sm btn-block" ><i class="bi bi-filetype-csv"> CSV</i></button>',
                                        extend: 'csv'
                                    }, {
                                        text: '<button class="btn btn-success btn-sm btn-block" ><i class="bi bi-filetype-xlsx"> Excel</i></button>',
                                        extend: 'excel'
                                    }, {
                                        text: '<button class="btn btn-warning btn-sm btn-block" ><i class="bi bi-printer-fill"> Imprimir</i></button>',
                                        extend: 'print'
                                    }]
                                },
                                {
