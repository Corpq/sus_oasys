...
?>
<h3>
    <center> <b>Horario de Atencion el Consultorio de {{$consultorio->nombre}}</b> </center>
</h3>
<hr>
    ...
    <tbody>
        ...
        <tr>
            ...
            $hora_fin <= $horario->hora_fin ){
                $nombre_doctor = $horario->doctor->nombres." ".$horario->doctor->apellidos." - ".$horario->doctor->especialidad;
                break;
                }
                }
                @endphp
