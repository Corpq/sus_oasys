...
class HorarioController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $request->validate([
            ...
            'consultorio_id' => 'required|exists:consultorios,id', //validar que el consultorio existe primeramente
        ]);

        //verificar si el horario ya existe para ese dia, en el rango de horas y consultorio
